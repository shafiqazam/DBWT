...
<body>
    ...
    <form method="get">
        <fieldset>
            <input type="radio" name="sort-value" <?php echo 'value="'.htmlspecialchars(0).'"';  if ($_GET['sort-value'] == "0") echo 'checked';?>> Sortierung nach Name <br>
            <input type="radio" name="sort-value" <?php echo 'value="'.htmlspecialchars(1).'"'; if ($_GET['sort-value'] == "1") echo 'checked'; ?>> Sortierung nach E-Mail <br>
            <label for="search_text">Filter:</label>
            <input id="search_text" type="text" name="search_text" value=<?php echo htmlspecialchars($_GET[GET_PARAM_SEARCH_TEXT]); ?>>
            <input type="submit">
        </fieldset>
    </form>
    <table border="1">
