...
$gericht = mysqli_query($link,$gericht_liste);
    ...
    function checkForm($link) {
        if(isset($_POST['datenschutz']) and isset($_POST['language']) and isset($_POST['user']) and isset($_POST['email'])) {
            $datenschutz = mysqli_real_escape_string($link,$_POST['datenschutz']);
            ...
            if(checkName($link)) {
                if(checkEmail($link)){
                    if(emailBlacklist()) {
                        ...
                        fwrite($file, $user."; ".$email."; ".$language."; ".'true'."\n");
                        fclose($file);
...
// Statistiken Array ( Auslesen und Schreiben von externer Datei )
        ...
        <div class="header">
            ...
            <div id="navigation">
                <ul>
                    ...
                    <li><a href="wunschgericht.php">Ihr Wunsch</a></li>
                </ul>
            </div>
        </div>
        <div class="body">
